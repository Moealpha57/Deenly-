...
const AppContent: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-[100dvh] bg-brand-secondary dark:bg-brand-navy text-slate-800 dark:text-slate-200 font-sans">
            {/* Added pt-[env(safe-area-inset-top)] for iOS Notch support */}
            <header className="flex items-center justify-between p-4 pt-[calc(1rem+env(safe-area-inset-top))] border-b border-slate-200 dark:border-slate-700 flex-shrink-0 bg-brand-secondary dark:bg-brand-navy z-10 sticky top-0">
